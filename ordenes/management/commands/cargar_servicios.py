...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        servicios = [
            ...
            ('Cambio de discos delanteros', 'Sustitución de discos delanteros', 1200.00),
            ('Cambio de discos traseros', 'Sustitución de discos traseros', 1100.00),
            ('Cambio de tambores', 'Sustitución de tambores traseros', 1500.00),
